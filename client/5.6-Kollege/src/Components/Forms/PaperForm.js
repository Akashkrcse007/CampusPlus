        ...
        <main className="paper">
          ...
          <form className="w-full md:w-1/3">
            ...
            >
              ...
              <option value="DR.CHANCHAL SUMAN">DR.CHANCHAL SUMAN</option>
              <option value="DR.SHAMBHU BHARTI">DR.SHAMBHU BHARTI</option>
              <option value="SUDHIR KUMAR PANDEY">SUDHIR KUMAR PANDEY</option>
              <option value="SHUSHIL KUMAR">SHUSHIL KUMAR</option>
              <option value="SHAMS TABREZ">SHAMS TABREZ</option>
              <option value="BIOLOGY MAM">BIOLOGY MAM</option>
            </select>
            <button
